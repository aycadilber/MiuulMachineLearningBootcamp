...
# AUC
roc_auc_score(y, y_prob)  #1.0

# overfite mi düştük? başarımı nasıl daha doğru değerlendiririm?
...
# model göremediği veride çok kötü model overfit oldu
...
# gözlem sayısı az olduğu için 5 katlı çapraz doğrulama yöntemiyle bakalım dedik.
# model başarımızı hipermarametre optimizasyonu yaparak başarımızı artırabiliiz.
# dengesiz veri yaklaşımı da yapabiliriz.
...
# bu aralıkları ön tanımlı değerlerin etrafındaki değerleri gireriz.

# gridsearchcv bu parametrelere göre arama yapılmasını istiyoruz.
...
# gridsearchcv içerisinde en iyi kombinasyona ait o modeli tutar
# dolayısıyla o model kullnarak tahmin etme işlemi gerçekleştirilebilir.
...
# bir diğer en iyi parametreleri modele atamanın yolu
...
# öyle bir işlem yapalım ki hangi değişken hangi önem düzeyine sahip olduğunu görelim
...
# validation_curve metodu nümerik olarak bize çıktılar verecek daha sonra biz onları görselleştireceğiz.
...
# SELECT CASE WHEN (x2 <= 127.5) THEN CASE WHEN (x8 <= 28.5) THEN CASE WHEN (x6 <= 45.39999961853027)
# THEN CASE WHEN (x6 <= 30.949999809265137) THEN CASE WHEN (x1 <= 7.5) THEN 0 ELSE 1 END ELSE 0 END ELSE CASE
# WHEN (x3 <= 99.0) THEN 1 ELSE 0 END END ELSE CASE WHEN (x6 <= 26.350000381469727) THEN CASE WHEN (x6 <= 9.649999618530273)
# THEN 1 ELSE 0 END ELSE CASE WHEN (x2 <= 99.5) THEN CASE WHEN (x2 <= 28.5) THEN 1 ELSE 0 END ELSE CASE WHEN (x7 <= 0.5609999895095825)
# THEN 0 ELSE 1 END END END END ELSE CASE WHEN (x6 <= 29.949999809265137) THEN CASE WHEN (x2 <= 145.5) THEN CASE WHEN (x5 <= 132.5)
# THEN CASE WHEN (x6 <= 28.149999618530273) THEN 0 ELSE 1 END ELSE 0 END ELSE CASE WHEN (x8 <= 25.5) THEN 0 ELSE CASE WHEN (x8 <= 61.0)
# THEN 1 ELSE 0 END END END ELSE CASE WHEN (x2 <= 157.5) THEN CASE WHEN (x8 <= 30.5) THEN CASE WHEN (x3 <= 61.0) THEN 1 ELSE 0 END ELSE 1 END ELSE CASE
# WHEN (x5 <= 629.5) THEN 1 ELSE 0 END END END END AS y
# FROM data
...
# 12. Saving and Loading Model
###############################################
# diyelim ki bir model kurduk ve modeli daha sonra tekrar kullanmak istiyorum

joblib.dump(cart_final, "cart_final.pkl")

cart_model_from_disc = joblib.load("datasets/cart_final.pkl")
